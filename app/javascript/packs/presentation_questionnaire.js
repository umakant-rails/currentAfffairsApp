var quesnrePrFunctions = (function () {
  ...
  var showNewQuestion = function(element, traverseType){
    ...
    if(traverseType == 'right'){
      ...
      quesnrePrFunctions.setDataIdAndShowQuestion(dataId,newDataId);
...
$(document).ready(function(){
  $("#presentation_id").on("change", function(){
    ...
    if(questionnaireId.length != ""){
      quesnrePrFunctions.setPresentationName(this);
    }
  });
  $(".current-affair-block").on("click", "#presentation-left-arrow", function(){
    var traverseType = 'left';
    if($(this).hasClass('active')){
      quesnrePrFunctions.showNewQuestion(this, traverseType)
    }
  });
  $(".current-affair-block").on("click", "#presentation-right-arrow", function(){
  ...
  $(".current-affair-block").on("click", ".questionnaire-close", function(){
    quesnrePrFunctions.resetQuestionnaireSelectionBlock();
  });
/*  
  $("#help-node").on("click", function(){
    quesnrePrFunctions.showHideHelpBox();
  });
